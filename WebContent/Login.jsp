...
<%@include file="Header.jsp" %>
	...
	<label class="pass">
		...
		<s:url value="ForgotP.jsp" var="CEmailURL" /><br>
		<center><s:a href="%{CEmailURL}"><h3 style="color:black; position:absolute;float:right;">Forgot Password?</h3></s:a></center>
		</div>
		<s:url value="AdminLogin.jsp" var="ADL" /><br>
		<center><s:a href="%{ADL}"><h3 style="color:black; ">Login as Admin</h3></s:a></center>
	<s:if test="ctr>0">
